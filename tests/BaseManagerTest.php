 ...
 * @package Tests
 */
// 1) Нет смысла тестировать менеджера через менеджер.
// Там, где для ассерта идет запрос к тестируемому классу, нужно делать это через нативный драйвер для работы с базой
// 2) Очень сложно читать тесты. Надо постоянно в голове держать набор данных и возвращаться к нему.
// Я бы вынес набор данных в константы (1 строка - 1 константа),
// а в тестах инициализировал именованные переменные, которые ссылались бы на необходимую константу.
// 3) Можно покрыть юнитами все Condition классы.
